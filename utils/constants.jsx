...
export const Constants = {
    ...
    THEMES: {
        default: {
            type: 'Kiron',
            awayIndicator: '#fdcd00',
            buttonBg: '#166de0',
            buttonColor: '#ffffff',
            centerChannelBg: '#ffffff',
            centerChannelColor: '#152539',
            codeTheme: 'github',
            dndIndicator: '#f74343',
            errorTextColor: '#eb4742',
            linkColor: '#2389d7',
            mentionBg: '#ffffff',
            mentionBj: '#ffffff',
            mentionColor: '#113893',
            mentionHighlightBg: '#ffe66c',
            mentionHighlightLink: '#6992e7',
            newMessageSeparator: '#ffe66c',
            onlineIndicator: '#34d5af',
            sidebarBg: '#ffffff',
            sidebarHeaderBg: '#ffffff',
            sidebarHeaderTextColor: '#152539',
            sidebarText: '#152539',
            sidebarTextActiveBorder: '#6992e7',
            sidebarTextActiveColor: '#152539',
            sidebarTextHoverBg: '#eeeeee',
            sidebarUnreadText: '#152539',
